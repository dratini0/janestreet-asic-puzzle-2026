...
class puzzle(wiring.Component):
    ...
    def elaborate(self, platform):
        ...
        # Testing outputs
        m.d.comb += [
            self.net_934.eq(m.submodules.floaroma.net_934),
            self.net_3136.eq(m.submodules.floaroma.net_3136),
            self.net_1526.eq(m.submodules.jubilife.net_1526),
            self.net_832.eq(m.submodules.jubilife.net_832),
            self.net_20.eq(m.submodules.jubilife.net_20),
            self.net_380.eq(m.submodules.jubilife.net_380),
            self.net_319.eq(m.submodules.jubilife.net_319),
            self.net_1508.eq(m.submodules.twinleaf.net_1508),
            self.net_435.eq(m.submodules.twinleaf.net_435),
            self.net_323.eq(m.submodules.twinleaf.net_323),
            self.net_378.eq(m.submodules.twinleaf.net_378),
            self.net_377.eq(m.submodules.twinleaf.net_377),
...
if __name__ == "__main__":
    ...
    with open(argv[1], "wt") as f:
        f.write(verilog.convert(top, name="puzzle_amaranth", ports=[
            top.I,
            top.enable,
            top.net_1447,
            top.net_934,
